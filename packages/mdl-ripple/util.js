...
export function supportsCssVariables(windowObj) {
  // NOTE: This does not work in Safari *on purpose* (see: https://bugs.webkit.org/show_bug.cgi?id=154669)
  // See the README for more info.
  return windowObj.CSS && typeof windowObj.CSS.supports === 'function' &&
